...
module Top_Student (
    ...
    reg [4:0] sbit = 5'd16;//slow clock's reading bit. Freq(sclk) = Freq(CLK) / 2^(sbit + 1).
    ...
    Graphics g(SwStates,BtnStates, volume, onRefresh, CLK[3], BadAppleClock, currentPixel, oled_data, led);    
