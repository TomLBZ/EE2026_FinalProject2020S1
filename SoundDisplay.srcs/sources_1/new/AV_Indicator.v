...
module AV_Indicator(
    ...
    always @ (CLK) begin
        ...
        if(volcounter[24]==1'b1) begin
                if (mic_max<mic_in) mic_max <= mic_in;   
        end
        if(volcounter[27]==1'b0) mic_max <= mic_max - 1'b1;
...
module SoundLevel (
    ...
    if (volcounter[22]==1'b0) begin
        if (volume <4'd10) begin 
            ...
            if (volcounter[18]==1'b0) begin
                an = 4'b1101;
                seg = 7'b1111001;
            end
            else if (volcounter[18]==1'b1) begin
                an = 4'b1110;
                case (volume)
