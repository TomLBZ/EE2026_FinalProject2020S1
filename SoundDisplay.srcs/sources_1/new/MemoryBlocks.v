...
module AudioVisualizationSceneBuilder(input CLK, input [1:0] THEME, input THK, input BD, input BG, input BAR, input TXT, input [3:0] LEVEL, output [63:0] CMD);
    reg [63:0] AudioBar [32:0];//33 commands
    reg [5:0] count = 0;
    reg [63:0] cmd;
    ...
    assign AudioBar[1] = DrawRect(7'd0, 6'd0, 7'd95, 6'd63, BD ? BT[THEME] : DEFCOL);// drawboarder outermost 1 pix at THK 1
    assign AudioBar[2] = DrawRect(7'd1, 6'd1, 7'd94, 6'd62, BD & THK ? BT[THEME] : DEFCOL);// drawboarder outermost 2 pix at THK 1
    assign AudioBar[3] = DrawRect(7'd2, 6'd2, 7'd93, 6'd61, BD & THK ? BT[THEME] : DEFCOL);// drawboarder outermost 3 pix at THK 1
    assign AudioBar[4] = FillRect(7'd42, 6'd58, 7'd53, 6'd59, BAR & (LEVEL >= 4'd0) ? LT[THEME] : DEFCOL);//Fill BtmLevel1
    assign AudioBar[5] = FillRect(7'd42, 6'd55, 7'd53, 6'd56, BAR & (LEVEL > 4'd0) ? LT[THEME] : DEFCOL);//Fill BtmLevel2
    assign AudioBar[6] = FillRect(7'd42, 6'd52, 7'd53, 6'd53, BAR & (LEVEL > 4'd1) ? LT[THEME] : DEFCOL);//Fill BtmLevel3
    assign AudioBar[7] = FillRect(7'd42, 6'd49, 7'd53, 6'd50, BAR & (LEVEL > 4'd2) ? LT[THEME] : DEFCOL);//Fill BtmLevel4
    assign AudioBar[8] = FillRect(7'd42, 6'd46, 7'd53, 6'd47, BAR & (LEVEL > 4'd3) ? LT[THEME] : DEFCOL);//Fill BtmLevel5
    assign AudioBar[9] = FillRect(7'd42, 6'd43, 7'd53, 6'd44, BAR & (LEVEL > 4'd4) ? LT[THEME] : DEFCOL);//Fill MidLevel6
    assign AudioBar[10] = FillRect(7'd42, 6'd40, 7'd53, 6'd41, BAR & (LEVEL > 4'd5) ? MT[THEME] : DEFCOL);//Fill MidLevel1
    assign AudioBar[11] = FillRect(7'd42, 6'd37, 7'd53, 6'd38, BAR & (LEVEL > 4'd6) ? MT[THEME] : DEFCOL);//Fill MidLevel2
    assign AudioBar[12] = FillRect(7'd42, 6'd34, 7'd53, 6'd35, BAR & (LEVEL > 4'd7) ? MT[THEME] : DEFCOL);//Fill MidLevel3
    assign AudioBar[13] = FillRect(7'd42, 6'd31, 7'd53, 6'd32, BAR & (LEVEL > 4'd8) ? MT[THEME] : DEFCOL);//Fill MidLevel4
    assign AudioBar[14] = FillRect(7'd42, 6'd28, 7'd53, 6'd29, BAR & (LEVEL > 4'd9) ? MT[THEME] : DEFCOL);//Fill TopLevel5
    assign AudioBar[15] = FillRect(7'd42, 6'd25, 7'd53, 6'd26, BAR & (LEVEL > 4'd10) ? HT[THEME] : DEFCOL);//Fill TopLevel1
    assign AudioBar[16] = FillRect(7'd42, 6'd22, 7'd53, 6'd23, BAR & (LEVEL > 4'd11) ? HT[THEME] : DEFCOL);//Fill TopLevel2
    assign AudioBar[17] = FillRect(7'd42, 6'd19, 7'd53, 6'd20, BAR & (LEVEL > 4'd12) ? HT[THEME] : DEFCOL);//Fill TopLevel3
    assign AudioBar[18] = FillRect(7'd42, 6'd16, 7'd53, 6'd17, BAR & (LEVEL > 4'd13) ? HT[THEME] : DEFCOL);//Fill TopLevel4
    assign AudioBar[19] = FillRect(7'd42, 6'd13, 7'd53, 6'd14, BAR & (LEVEL > 4'd14) ? HT[THEME] : DEFCOL);//Fill TopLevel5    
    assign AudioBar[20] = DrawChar(7'd55, 6'd53, 20'd11, TXT & (LEVEL >= 4'd0) ? LT[THEME] : DEFCOL,1'd0); //L, original size
    assign AudioBar[21] = DrawChar(7'd60, 6'd53, 20'd14, TXT & (LEVEL >= 4'd0) ? LT[THEME] : DEFCOL,1'd0); //O, original size
    assign AudioBar[22] = DrawChar(7'd65, 6'd53, 20'd22, TXT & (LEVEL >= 4'd0) ? LT[THEME] : DEFCOL,1'd0); //W, original size
    assign AudioBar[23] = DrawChar(7'd75, 6'd53, 20'd21, TXT & (LEVEL >= 4'd0) ? LT[THEME] : DEFCOL,1'd0); //V, original size
    assign AudioBar[24] = DrawChar(7'd80, 6'd53, 20'd14, TXT & (LEVEL >= 4'd0) ? LT[THEME] : DEFCOL,1'd0); //O, original size
    assign AudioBar[25] = DrawChar(7'd85, 6'd53, 20'd11, TXT & (LEVEL >= 4'd0) ? LT[THEME] : DEFCOL,1'd0); //L, original size
    assign AudioBar[26] = DrawChar(7'd55, 6'd13, 20'd7, TXT & (LEVEL > 4'd10) ? HT[THEME] : DEFCOL,1'd0); //H, original size
    assign AudioBar[27] = DrawChar(7'd60, 6'd13, 20'd8, TXT & (LEVEL > 4'd10) ? HT[THEME] : DEFCOL,1'd0); //I, original size
    assign AudioBar[28] = DrawChar(7'd65, 6'd13, 20'd6, TXT & (LEVEL > 4'd10) ? HT[THEME] : DEFCOL,1'd0); //G, original size
    assign AudioBar[29] = DrawChar(7'd70, 6'd13, 20'd7, TXT & (LEVEL > 4'd10) ? HT[THEME] : DEFCOL,1'd0); //H, original size
    assign AudioBar[30] = DrawChar(7'd75, 6'd13, 20'd21, TXT & (LEVEL > 4'd10) ? HT[THEME] : DEFCOL,1'd0); //V, original size
    assign AudioBar[31] = DrawChar(7'd80, 6'd13, 20'd14, TXT & (LEVEL > 4'd10) ? HT[THEME] : DEFCOL,1'd0); //O, original size
    assign AudioBar[32] = DrawChar(7'd85, 6'd13, 20'd11, TXT & (LEVEL > 4'd10) ? HT[THEME] : DEFCOL,1'd0); //L, original size
    always @(posedge CLK) begin
        cmd = AudioBar[count];
        count = count + 6'd1;
        if (count == 6'd33) count = 0;
    end
    assign CMD = cmd;
endmodule

module StartScreenSceneBuilder(input CLK, input [1:0] CURSORINDEX, output CMD);
    reg [63:0] StartScreen [1:0];//2 commands
    reg count = 0;
    reg [63:0] cmd;
    reg [15:0] WHITE = {5'd31,6'd63,5'd31};
    `include "CommandFunctions.v"
    assign StartScreen[0] = QuickDrawSceneSprite(4'd0, 3'd0, WHITE,3'd1,2'b0 );
    assign StartScreen[1] = DrawSceneSprite(7'd47,6'd31,WHITE,3'd1,2'b0);
    always @(posedge CLK) begin
